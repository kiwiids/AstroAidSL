...
export function LocationSearch({
  ...
  return (
    <div className="w-[280px] h-screen bg-[#111111] fixed left-0 top-0 flex flex-col px-6 py-6 border-r border-white/5 z-40">
      {/* Logo */}
      <div className="mb-6">
        <h1 className="tracking-[0.2em] text-[#E0E0E0] font-mono">ASTROAID</h1>
        <p className="text-[#B0B0B0] mt-1">Sri Lanka</p>
      </div>
