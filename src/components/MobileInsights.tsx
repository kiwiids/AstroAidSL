...
export function MobileInsights({ isOpen, onClose, selectedRiskTypes, selectedRiskLevels }: MobileInsightsProps) {
  return (
      ...
      <SheetContent side="right" className="w-full sm:w-[400px] bg-[#111111] border-white/5 p-0">
        <div className="h-full flex flex-col">
          <SheetHeader className="px-6 py-6 border-b border-white/5">
            <SheetTitle className="text-[#E0E0E0] text-left">Insights</SheetTitle>
          </SheetHeader>
          ...
          <Tabs defaultValue="overview" className="flex-1 flex flex-col">
            <TabsList className="mx-6 mt-4 bg-[#0A0A0A] border border-white/5">
              ...
              <TabsTrigger value="alerts" className="data-[state=active]:bg-[#3B82F6] data-[state=active]:text-white">
                Alerts
              </TabsTrigger>
            </TabsList>

            <TabsContent value="overview" className="flex-1 px-6 py-4 space-y-6 overflow-y-auto">
            ...
            <TabsContent value="alerts" className="flex-1 px-6 py-4 overflow-hidden">
              <div className="h-full">
                <h3 className="text-[#E0E0E0] mb-4">Recent Alerts</h3>
                <div className="bg-[#0A0A0A] rounded-xl border border-white/5 overflow-hidden h-[calc(100%-3rem)]">
